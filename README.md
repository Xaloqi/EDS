...
[![Version](https://img.shields.io/badge/version-v1.7.4-blue)](https://github.com/Xaloqi/EDS/releases/tag/v1.7.4)
...
```bash
pip install west
west init -m https://github.com/Xaloqi/EDS --mr v1.7.4 eds-workspace
