...
[![Version](https://img.shields.io/badge/version-v1.8.0-blue)](https://github.com/Xaloqi/EDS/releases/tag/v1.8.0)
...
```bash
pip install west
west init -m https://github.com/Xaloqi/EDS --mr v1.8.0 eds-workspace
