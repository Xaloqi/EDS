...
[![Version](https://img.shields.io/badge/version-v1.13.1-blue)](https://github.com/Xaloqi/EDS/releases/tag/v1.13.1)
...
```bash
pip install west
west init -m https://github.com/Xaloqi/EDS --mr v1.13.1 eds-workspace
