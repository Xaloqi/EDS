...
collected** for `basic_ecu` (v1.16.0). That is a *collection* count, not a claim that
...
builds the ELF, and verifies it exists. The same unit test modules run against the FreeRTOS
