...
log = logging.getLogger("conftest.sensorecu")
...
class _InlineEcuState:
    def __init__(self) -> None:
        ...
        self.did_store: dict = {
            ...
            53249: bytearray([0xAA] * 1),
            53250: bytearray([0xAA] * 2),
            53251: bytearray([0xAA] * 1),
            53264: bytearray([0xAA] * 1),
            53265: bytearray([0xAA] * 1),
        }
        self.dtcs: list = [
            {"code": 13631745, "status": 0x00},
            {"code": 13631746, "status": 0x00},
            {"code": 13632001, "status": 0x00},
            {"code": 13632002, "status": 0x00},
        ]
