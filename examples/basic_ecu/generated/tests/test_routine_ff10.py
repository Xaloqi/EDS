...
class TestStartErasenvm:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF10 (EraseNVM)
...
class TestResultsErasenvm:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF10

    EraseNVM has ROUTINE_SUPPORT_RESULTS.
    """
...
class TestStopNotSupportedErasenvm:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF10

    EraseNVM does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateErasenvm:
    """
    0xFF10 (EraseNVM) requires programming session (ordinal 2).
...
class TestSecurityGateErasenvm:
    """
    0xFF10 (EraseNVM) requires security_level 1.
...
class TestProtocolErasenvm:
    """
    Protocol boundary cases for 0xFF10 (EraseNVM).
