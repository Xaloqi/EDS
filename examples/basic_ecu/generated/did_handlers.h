 ...
 *
 * TODO [APPLICATION]: Implement to return current sensor / ECU data for Vehicle Identification Number.
 *
 ...
 *
 * TODO [APPLICATION]: Implement to return current sensor / ECU data for ECU Serial Number.
 *
 * @param[out] buf      Output buffer for DID data.
 ...
 *
 * TODO [APPLICATION]: Implement to return current sensor / ECU data for Vehicle Manufacturer Spare Part Number.
 *
 * @param[out] buf      Output buffer for DID data.
 ...
 *
 * TODO [APPLICATION]: Implement to return current sensor / ECU data for Engine Speed.
 *
 * @param[out] buf      Output buffer for DID data.
 ...
 *
 * TODO [APPLICATION]: Implement to return current sensor / ECU data for Coolant Temperature.
 *
 * @param[out] buf      Output buffer for DID data.
 ...
 * Data length  : 11 byte(s)
 *
 * TODO [APPLICATION]: Implement to apply new value for Vehicle Manufacturer Spare Part Number.
 *
