...
ROUTINE_NAME:     str  = "SensorSelfTest"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 1
...
class TestStartSensorselftest:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF01 (SensorSelfTest)
...
class TestResultsSensorselftest:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF01

    SensorSelfTest has ROUTINE_SUPPORT_RESULTS.
    """
...
class TestStopNotSupportedSensorselftest:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF01

    SensorSelfTest does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateSensorselftest:
    """
    0xFF01 (SensorSelfTest) requires extended session (ordinal 3).
...
class TestProtocolSensorselftest:
    """
    Protocol boundary cases for 0xFF01 (SensorSelfTest).
