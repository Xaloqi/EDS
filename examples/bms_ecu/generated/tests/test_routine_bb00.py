...
#
# Run:  pytest generated/tests/test_routine_bb00.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 47872
ROUTINE_HEX:      str  = "0xBB00"
ROUTINE_NAME:     str  = "BMS_SelfTest"
ROUTINE_HI:       int  = 187
ROUTINE_LO:       int  = 0
...
class TestStartBmsselftest:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xBB00 (BMS_SelfTest)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xBB00 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xBB, 0x00]
...
class TestResultsBmsselftest:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xBB00

    BMS_SelfTest has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xBB00 after start.
...
class TestStopNotSupportedBmsselftest:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xBB00

    BMS_SelfTest does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateBmsselftest:
    """
    0xBB00 (BMS_SelfTest) requires extended session (ordinal 3).
...
class TestProtocolBmsselftest:
    """
    Protocol boundary cases for 0xBB00 (BMS_SelfTest).
