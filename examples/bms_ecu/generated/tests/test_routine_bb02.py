...
#
# Run:  pytest generated/tests/test_routine_bb02.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 47874
ROUTINE_HEX:      str  = "0xBB02"
ROUTINE_NAME:     str  = "BMS_ContactorFunctionalTest"
ROUTINE_HI:       int  = 187
ROUTINE_LO:       int  = 2
...
class TestStartBmscontactorfunctionaltest:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xBB02 (BMS_ContactorFunctionalTest)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xBB02 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xBB, 0x02]
...
class TestResultsBmscontactorfunctionaltest:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xBB02

    BMS_ContactorFunctionalTest has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xBB02 after start.
...
class TestStopNotSupportedBmscontactorfunctionaltest:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xBB02

    BMS_ContactorFunctionalTest does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateBmscontactorfunctionaltest:
    """
    0xBB02 (BMS_ContactorFunctionalTest) requires extended session (ordinal 3).
...
class TestSecurityGateBmscontactorfunctionaltest:
    """
    0xBB02 (BMS_ContactorFunctionalTest) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xBB02 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolBmscontactorfunctionaltest:
    """
    Protocol boundary cases for 0xBB02 (BMS_ContactorFunctionalTest).
