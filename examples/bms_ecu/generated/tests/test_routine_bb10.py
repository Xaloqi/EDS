...
#
# Run:  pytest generated/tests/test_routine_bb10.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 47888
ROUTINE_HEX:      str  = "0xBB10"
ROUTINE_NAME:     str  = "BMS_ResetSoCToFullCharge"
ROUTINE_HI:       int  = 187
ROUTINE_LO:       int  = 16
...
class TestStartBmsresetsoctofullcharge:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xBB10 (BMS_ResetSoCToFullCharge)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xBB10 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xBB, 0x10]
...
class TestStopNotSupportedBmsresetsoctofullcharge:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xBB10

    BMS_ResetSoCToFullCharge does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateBmsresetsoctofullcharge:
    """
    0xBB10 (BMS_ResetSoCToFullCharge) requires programming session (ordinal 2).
...
class TestSecurityGateBmsresetsoctofullcharge:
    """
    0xBB10 (BMS_ResetSoCToFullCharge) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xBB10 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolBmsresetsoctofullcharge:
    """
    Protocol boundary cases for 0xBB10 (BMS_ResetSoCToFullCharge).
