...
#
# Run:  pytest generated/tests/test_routine_bb01.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 47873
ROUTINE_HEX:      str  = "0xBB01"
ROUTINE_NAME:     str  = "BMS_ForcePassiveBalance"
ROUTINE_HI:       int  = 187
ROUTINE_LO:       int  = 1
MIN_SESSION:      int  = 3    # 1=default 2=programming 3=extended
SECURITY_LEVEL:   int  = 1
SUPPORT_START:    bool = True
SUPPORT_STOP:     bool = True
...
class TestStartBmsforcepassivebalance:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xBB01 (BMS_ForcePassiveBalance)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xBB01 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xBB, 0x01]
...
class TestResultsBmsforcepassivebalance:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xBB01

    BMS_ForcePassiveBalance has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xBB01 after start.
...
class TestSessionGateBmsforcepassivebalance:
    """
    0xBB01 (BMS_ForcePassiveBalance) requires extended session (ordinal 3).
...
class TestSecurityGateBmsforcepassivebalance:
    """
    0xBB01 (BMS_ForcePassiveBalance) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xBB01 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolBmsforcepassivebalance:
    """
    Protocol boundary cases for 0xBB01 (BMS_ForcePassiveBalance).
