...
log = logging.getLogger("conftest.bms_maincontroller")
...
class _InlineEcuState:
    def __init__(self) -> None:
        ...
        self.did_store: dict = {
            ...
            56064: bytearray([0xAA] * 4),
            56065: bytearray([0xAA] * 2),
            56066: bytearray([0xAA] * 2),
            56067: bytearray([0xAA] * 1),
            56068: bytearray([0xAA] * 2),
            56321: bytearray([0xAA] * 2),
            56322: bytearray([0xAA] * 2),
            56323: bytearray([0xAA] * 2),
            56324: bytearray([0xAA] * 2),
            56576: bytearray([0xAA] * 1),
            56577: bytearray([0xAA] * 1),
            56578: bytearray([0xAA] * 1),
            56579: bytearray([0xAA] * 1),
            56832: bytearray([0xAA] * 1),
            56833: bytearray([0xAA] * 1),
            56834: bytearray([0xAA] * 1),
            55552: bytearray([0xAA] * 2),
            55553: bytearray([0xAA] * 4),
            55568: bytearray([0xAA] * 2),
            55569: bytearray([0xAA] * 2),
        }
        self.dtcs: list = [
            {"code": 13697280, "status": 0x00},
            {"code": 13697536, "status": 0x00},
            {"code": 13697792, "status": 0x00},
            {"code": 13698048, "status": 0x00},
            {"code": 13698304, "status": 0x00},
            {"code": 13698560, "status": 0x00},
            {"code": 13698816, "status": 0x00},
            {"code": 13699072, "status": 0x00},
            {"code": 12583168, "status": 0x00},
            {"code": 13699328, "status": 0x00},
        ]
...
def _inline_handle(pdu: bytes, state: _InlineEcuState, verbose: bool) -> Optional[bytes]:
    ...
    if sid == 0x10:
        ...
        p2_hi=0; p2_lo=50; p2s_hi=19; p2s_lo=136
