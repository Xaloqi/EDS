...
#
# Run:  pytest generated/tests/test_routine_bb11.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 47889
ROUTINE_HEX:      str  = "0xBB11"
ROUTINE_NAME:     str  = "BMS_ClearFaultHistory"
ROUTINE_HI:       int  = 187
ROUTINE_LO:       int  = 17
...
class TestStartBmsclearfaulthistory:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xBB11 (BMS_ClearFaultHistory)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xBB11 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xBB, 0x11]
...
class TestStopNotSupportedBmsclearfaulthistory:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xBB11

    BMS_ClearFaultHistory does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateBmsclearfaulthistory:
    """
    0xBB11 (BMS_ClearFaultHistory) requires programming session (ordinal 2).
...
class TestSecurityGateBmsclearfaulthistory:
    """
    0xBB11 (BMS_ClearFaultHistory) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xBB11 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolBmsclearfaulthistory:
    """
    Protocol boundary cases for 0xBB11 (BMS_ClearFaultHistory).
