...
#
# Run:  pytest generated/tests/test_routine_ff01.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 65281
ROUTINE_HEX:      str  = "0xFF01"
ROUTINE_NAME:     str  = "VerifyBootloaderIntegrity"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 1
...
class TestStartVerifybootloaderintegrity:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF01 (VerifyBootloaderIntegrity)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xFF01 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xFF, 0x01]
...
class TestResultsVerifybootloaderintegrity:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF01

    VerifyBootloaderIntegrity has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xFF01 after start.
...
class TestStopNotSupportedVerifybootloaderintegrity:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF01

    VerifyBootloaderIntegrity does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateVerifybootloaderintegrity:
    """
    0xFF01 (VerifyBootloaderIntegrity) requires programming session (ordinal 2).
...
class TestSecurityGateVerifybootloaderintegrity:
    """
    0xFF01 (VerifyBootloaderIntegrity) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xFF01 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolVerifybootloaderintegrity:
    """
    Protocol boundary cases for 0xFF01 (VerifyBootloaderIntegrity).
