...
ROUTINE_NAME:     str  = "CheckProgrammingPreconditions"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 0
...
class TestStartCheckprogrammingpreconditions:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF00 (CheckProgrammingPreconditions)
...
class TestResultsCheckprogrammingpreconditions:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF00

    CheckProgrammingPreconditions has ROUTINE_SUPPORT_RESULTS.
    """
...
class TestStopNotSupportedCheckprogrammingpreconditions:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF00

    CheckProgrammingPreconditions does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateCheckprogrammingpreconditions:
    """
    0xFF00 (CheckProgrammingPreconditions) requires extended session (ordinal 3).
...
class TestProtocolCheckprogrammingpreconditions:
    """
    Protocol boundary cases for 0xFF00 (CheckProgrammingPreconditions).
