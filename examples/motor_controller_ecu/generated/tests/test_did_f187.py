...
DID_ID:         int  = 61831
DID_HEX:        str  = "0xF187"
DID_NAME:       str  = "VehicleManufacturerSparePartNumber"
DID_HI:         int  = 241
DID_LO:         int  = 135
DATA_LENGTH:    int  = 11
...
class TestReadVehiclemanufacturersparepartnumber:
    """
    SID 0x22 ReadDataByIdentifier — DID 0xF187 (VehicleManufacturerSparePartNumber)
    ...
    def test_happy_path_returns_correct_length(
        ...
        assert pdu is not None, f"No response reading DID 0xF187 (VehicleManufacturerSparePartNumber)"
    ...
    def test_response_data_not_all_zero(
        ...
        if all(b == 0 for b in data_payload):
            import warnings
            warnings.warn(
                f"DID 0xF187 (VehicleManufacturerSparePartNumber) returned all-zero data — "
...
class TestWriteVehiclemanufacturersparepartnumber:
    """
    SID 0x2E WriteDataByIdentifier — DID 0xF187 (VehicleManufacturerSparePartNumber)
