...
#
# Run:  pytest generated/tests/test_routine_cc02.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 52226
ROUTINE_HEX:      str  = "0xCC02"
ROUTINE_NAME:     str  = "MC_GateDriverFunctionalTest"
ROUTINE_HI:       int  = 204
ROUTINE_LO:       int  = 2
...
class TestStartMcgatedriverfunctionaltest:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xCC02 (MC_GateDriverFunctionalTest)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xCC02 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xCC, 0x02]
...
class TestResultsMcgatedriverfunctionaltest:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xCC02

    MC_GateDriverFunctionalTest has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xCC02 after start.
...
class TestStopNotSupportedMcgatedriverfunctionaltest:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xCC02

    MC_GateDriverFunctionalTest does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateMcgatedriverfunctionaltest:
    """
    0xCC02 (MC_GateDriverFunctionalTest) requires extended session (ordinal 3).
...
class TestSecurityGateMcgatedriverfunctionaltest:
    """
    0xCC02 (MC_GateDriverFunctionalTest) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xCC02 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolMcgatedriverfunctionaltest:
    """
    Protocol boundary cases for 0xCC02 (MC_GateDriverFunctionalTest).
