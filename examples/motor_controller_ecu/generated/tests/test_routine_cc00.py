...
#
# Run:  pytest generated/tests/test_routine_cc00.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 52224
ROUTINE_HEX:      str  = "0xCC00"
ROUTINE_NAME:     str  = "MC_SelfTest"
ROUTINE_HI:       int  = 204
ROUTINE_LO:       int  = 0
...
class TestStartMcselftest:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xCC00 (MC_SelfTest)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xCC00 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xCC, 0x00]
...
class TestResultsMcselftest:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xCC00

    MC_SelfTest has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xCC00 after start.
...
class TestStopNotSupportedMcselftest:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xCC00

    MC_SelfTest does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateMcselftest:
    """
    0xCC00 (MC_SelfTest) requires extended session (ordinal 3).
...
class TestProtocolMcselftest:
    """
    Protocol boundary cases for 0xCC00 (MC_SelfTest).
