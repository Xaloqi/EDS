...
#
# Run:  pytest generated/tests/test_routine_cc11.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 52241
ROUTINE_HEX:      str  = "0xCC11"
ROUTINE_NAME:     str  = "MC_ForceMotorInhibit"
ROUTINE_HI:       int  = 204
ROUTINE_LO:       int  = 17
...
class TestStartMcforcemotorinhibit:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xCC11 (MC_ForceMotorInhibit)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xCC11 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xCC, 0x11]
...
class TestSessionGateMcforcemotorinhibit:
    """
    0xCC11 (MC_ForceMotorInhibit) requires extended session (ordinal 3).
...
class TestSecurityGateMcforcemotorinhibit:
    """
    0xCC11 (MC_ForceMotorInhibit) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xCC11 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolMcforcemotorinhibit:
    """
    Protocol boundary cases for 0xCC11 (MC_ForceMotorInhibit).
