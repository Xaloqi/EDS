...
#
# Run:  pytest generated/tests/test_routine_cc12.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 52242
ROUTINE_HEX:      str  = "0xCC12"
ROUTINE_NAME:     str  = "MC_ClearFaultHistory"
ROUTINE_HI:       int  = 204
ROUTINE_LO:       int  = 18
...
class TestStartMcclearfaulthistory:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xCC12 (MC_ClearFaultHistory)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xCC12 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xCC, 0x12]
...
class TestStopNotSupportedMcclearfaulthistory:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xCC12

    MC_ClearFaultHistory does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateMcclearfaulthistory:
    """
    0xCC12 (MC_ClearFaultHistory) requires programming session (ordinal 2).
...
class TestSecurityGateMcclearfaulthistory:
    """
    0xCC12 (MC_ClearFaultHistory) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xCC12 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolMcclearfaulthistory:
    """
    Protocol boundary cases for 0xCC12 (MC_ClearFaultHistory).
