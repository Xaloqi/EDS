...
log = logging.getLogger("conftest.motorcontroller_inverter")
...
class _InlineEcuState:
    def __init__(self) -> None:
        ...
        self.did_store: dict = {
            ...
            57345: bytearray([0xAA] * 2),
            57346: bytearray([0xAA] * 2),
            57347: bytearray([0xAA] * 2),
            57348: bytearray([0xAA] * 2),
            57349: bytearray([0xAA] * 2),
            57601: bytearray([0xAA] * 2),
            57602: bytearray([0xAA] * 2),
            57603: bytearray([0xAA] * 2),
            57604: bytearray([0xAA] * 2),
            57605: bytearray([0xAA] * 2),
            57857: bytearray([0xAA] * 4),
            57858: bytearray([0xAA] * 2),
            57859: bytearray([0xAA] * 1),
            58113: bytearray([0xAA] * 1),
            58114: bytearray([0xAA] * 1),
            58115: bytearray([0xAA] * 1),
            58116: bytearray([0xAA] * 1),
            58117: bytearray([0xAA] * 1),
            58369: bytearray([0xAA] * 2),
            58370: bytearray([0xAA] * 1),
            58625: bytearray([0xAA] * 2),
            58626: bytearray([0xAA] * 2),
            58627: bytearray([0xAA] * 2),
        }
        self.dtcs: list = [
            {"code": 13762816, "status": 0x00},
            {"code": 13763072, "status": 0x00},
            {"code": 13763328, "status": 0x00},
            {"code": 13763584, "status": 0x00},
            {"code": 13763840, "status": 0x00},
            {"code": 13764096, "status": 0x00},
            {"code": 13764352, "status": 0x00},
            {"code": 13764608, "status": 0x00},
            {"code": 12583168, "status": 0x00},
            {"code": 13764864, "status": 0x00},
        ]
