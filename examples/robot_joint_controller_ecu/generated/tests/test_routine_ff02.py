...
#
# Run:  pytest generated/tests/test_routine_ff02.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 65282
ROUTINE_HEX:      str  = "0xFF02"
ROUTINE_NAME:     str  = "ClearFaultHistory"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 2
...
class TestStartClearfaulthistory:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF02 (ClearFaultHistory)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xFF02 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xFF, 0x02]
...
class TestStopNotSupportedClearfaulthistory:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF02

    ClearFaultHistory does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateClearfaulthistory:
    """
    0xFF02 (ClearFaultHistory) requires extended session (ordinal 3).
...
class TestSecurityGateClearfaulthistory:
    """
    0xFF02 (ClearFaultHistory) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xFF02 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolClearfaulthistory:
    """
    Protocol boundary cases for 0xFF02 (ClearFaultHistory).
