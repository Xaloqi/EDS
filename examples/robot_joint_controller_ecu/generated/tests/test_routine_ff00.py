...
class TestStartHomeaxis0:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF00 (HomeAxis0)
...
class TestResultsHomeaxis0:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF00

    HomeAxis0 has ROUTINE_SUPPORT_RESULTS.
    """
...
class TestStopNotSupportedHomeaxis0:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF00

    HomeAxis0 does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateHomeaxis0:
    """
    0xFF00 (HomeAxis0) requires extended session (ordinal 3).
...
class TestSecurityGateHomeaxis0:
    """
    0xFF00 (HomeAxis0) requires security_level 1.
...
class TestProtocolHomeaxis0:
    """
    Protocol boundary cases for 0xFF00 (HomeAxis0).
