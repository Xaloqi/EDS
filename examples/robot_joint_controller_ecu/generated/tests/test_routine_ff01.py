...
ROUTINE_NAME:     str  = "ApplyCalibration"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 1
...
class TestStartApplycalibration:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF01 (ApplyCalibration)
...
class TestResultsApplycalibration:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF01

    ApplyCalibration has ROUTINE_SUPPORT_RESULTS.
    """
...
class TestStopNotSupportedApplycalibration:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF01

    ApplyCalibration does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateApplycalibration:
    """
    0xFF01 (ApplyCalibration) requires extended session (ordinal 3).
...
class TestSecurityGateApplycalibration:
    """
    0xFF01 (ApplyCalibration) requires security_level 1.
...
class TestProtocolApplycalibration:
    """
    Protocol boundary cases for 0xFF01 (ApplyCalibration).
