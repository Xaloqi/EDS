...
log = logging.getLogger("conftest.robotjointcontroller")
...
class _InlineEcuState:
    def __init__(self) -> None:
        ...
        self.did_store: dict = {
            ...
            40960: bytearray([0xAA] * 4),
            40961: bytearray([0xAA] * 2),
            40962: bytearray([0xAA] * 2),
            40963: bytearray([0xAA] * 1),
            40964: bytearray([0xAA] * 1),
            40976: bytearray([0xAA] * 4),
            40977: bytearray([0xAA] * 4),
            40978: bytearray([0xAA] * 4),
        }
        self.dtcs: list = [
            {"code": 10486017, "status": 0x00},
            {"code": 10486273, "status": 0x00},
            {"code": 10486019, "status": 0x00},
            {"code": 10486529, "status": 0x00},
            {"code": 10486530, "status": 0x00},
        ]
