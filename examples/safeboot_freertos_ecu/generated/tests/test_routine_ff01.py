...
#
# Routine   : 0xFF01  (VerifyOTASlotIntegrity)
...
ROUTINE_NAME:     str  = "VerifyOTASlotIntegrity"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 1
...
class TestStartVerifyotaslotintegrity:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF01 (VerifyOTASlotIntegrity)
...
class TestResultsVerifyotaslotintegrity:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF01

    VerifyOTASlotIntegrity has ROUTINE_SUPPORT_RESULTS.
    """
...
class TestStopNotSupportedVerifyotaslotintegrity:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF01

    VerifyOTASlotIntegrity does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateVerifyotaslotintegrity:
    """
    0xFF01 (VerifyOTASlotIntegrity) requires programming session (ordinal 2).
...
class TestSecurityGateVerifyotaslotintegrity:
    """
    0xFF01 (VerifyOTASlotIntegrity) requires security_level 1.
...
class TestProtocolVerifyotaslotintegrity:
    """
    Protocol boundary cases for 0xFF01 (VerifyOTASlotIntegrity).
