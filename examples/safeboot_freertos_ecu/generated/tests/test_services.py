...
#   0xFF01  VerifyOTASlotIntegrity  session=programming  security=1
# =============================================================================
...
class TestRoutineControl:
    ...
    def test_start_verifyotaslotintegrity(self, uds_bus: IsoTpTransport, aes_keys: dict) -> None:
        """
        startRoutine 0xFF01 (VerifyOTASlotIntegrity) → 0x71 0x01 0xFF01.
    ...
    def test_verifyotaslotintegrity_session_gate(self, uds_bus: IsoTpTransport) -> None:
        """
        0xFF01 (VerifyOTASlotIntegrity) in Default session → NRC 0x7F.
    ...
    def test_verifyotaslotintegrity_security_gate(self, uds_bus: IsoTpTransport) -> None:
        """
        0xFF01 (VerifyOTASlotIntegrity) without Level 1 unlock → NRC 0x33.
        """
        _session(uds_bus, SESSION_PROGRAMMING)
    ...
    def test_verifyotaslotintegrity_stop_not_supported(self, uds_bus: IsoTpTransport, aes_keys: dict) -> None:
        """
        stopRoutine 0xFF01 (VerifyOTASlotIntegrity) → NRC 0x12 (not in support flags).
        """
        _session(uds_bus, SESSION_PROGRAMMING)
        _unlock(uds_bus, 1, aes_keys)
        pdu = uds_bus.request(bytes([SID_ROUTINE_CONTROL, 0x02,
