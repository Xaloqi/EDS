...
#     support: start results#   RID 0xFF01  VerifyOTASlotIntegrity
...
class TestFirmwareRoutine_verifyotaslotintegrity:
    """
    SID 0x31 — RID 0xFF01 VerifyOTASlotIntegrity
    ...
    def test_start_routine_happy_path(
        ...
        """
        startRoutine 0xFF01 (VerifyOTASlotIntegrity) in UDS_SESSION_PROGRAMMING session → 0x71 0x01.
    ...
    def test_security_gate_locked_nrc(
        ...
        VerifyOTASlotIntegrity requires security_level = 1.
    ...
    def test_stop_not_supported_nrc(
        ...
        VerifyOTASlotIntegrity support_flags does not include ROUTINE_SUPPORT_STOP.
        service_0x31.c: stop_cb is NULL → NRC 0x12.
        """
        _enter_session(firmware_bus, SESSION_PROGRAMMING)
        _unlock_level(firmware_bus, 1)
    ...
    def test_request_results_happy_path(
        ...
        VerifyOTASlotIntegrity includes ROUTINE_SUPPORT_RESULTS.
        Stub callback returns UDS_STATUS_OK with zero result bytes.
        Response: [0x71, 0x03, RID_hi, RID_lo]
        """
        _enter_session(firmware_bus, SESSION_PROGRAMMING)
