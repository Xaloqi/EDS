...
log = logging.getLogger("conftest.safebootfreertosecu")
...
class _InlineEcuState:
    def __init__(self) -> None:
        ...
        self.did_store: dict = {
            ...
            61825: bytearray([0xAA] * 8),
            61830: bytearray([0xAA] * 1),
            61834: bytearray([0xAA] * 10),
        }
        self.dtcs: list = [
            {"code": 15728641, "status": 0x00},
            {"code": 15728642, "status": 0x00},
            {"code": 15728643, "status": 0x00},
        ]
