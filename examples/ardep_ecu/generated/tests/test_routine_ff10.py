...
#
# Run:  pytest generated/tests/test_routine_ff10.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 65296
ROUTINE_HEX:      str  = "0xFF10"
ROUTINE_NAME:     str  = "EraseApplicationFlash"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 16
...
class TestStartEraseapplicationflash:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF10 (EraseApplicationFlash)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xFF10 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xFF, 0x10]
...
class TestResultsEraseapplicationflash:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF10

    EraseApplicationFlash has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xFF10 after start.
...
class TestStopNotSupportedEraseapplicationflash:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF10

    EraseApplicationFlash does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateEraseapplicationflash:
    """
    0xFF10 (EraseApplicationFlash) requires programming session (ordinal 2).
...
class TestSecurityGateEraseapplicationflash:
    """
    0xFF10 (EraseApplicationFlash) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xFF10 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolEraseapplicationflash:
    """
    Protocol boundary cases for 0xFF10 (EraseApplicationFlash).
