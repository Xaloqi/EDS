...
#
# Run:  pytest generated/tests/test_routine_ff11.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 65297
ROUTINE_HEX:      str  = "0xFF11"
ROUTINE_NAME:     str  = "VerifyApplicationImage"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 17
...
class TestStartVerifyapplicationimage:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF11 (VerifyApplicationImage)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xFF11 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xFF, 0x11]
...
class TestResultsVerifyapplicationimage:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF11

    VerifyApplicationImage has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xFF11 after start.
...
class TestStopNotSupportedVerifyapplicationimage:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF11

    VerifyApplicationImage does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateVerifyapplicationimage:
    """
    0xFF11 (VerifyApplicationImage) requires programming session (ordinal 2).
...
class TestSecurityGateVerifyapplicationimage:
    """
    0xFF11 (VerifyApplicationImage) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xFF11 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolVerifyapplicationimage:
    """
    Protocol boundary cases for 0xFF11 (VerifyApplicationImage).
