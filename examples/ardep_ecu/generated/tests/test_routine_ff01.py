...
ROUTINE_NAME:     str  = "ResetCalibrationToDefaults"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 1
...
class TestStartResetcalibrationtodefaults:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF01 (ResetCalibrationToDefaults)
...
class TestStopNotSupportedResetcalibrationtodefaults:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF01

    ResetCalibrationToDefaults does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateResetcalibrationtodefaults:
    """
    0xFF01 (ResetCalibrationToDefaults) requires extended session (ordinal 3).
...
class TestSecurityGateResetcalibrationtodefaults:
    """
    0xFF01 (ResetCalibrationToDefaults) requires security_level 1.
...
class TestProtocolResetcalibrationtodefaults:
    """
    Protocol boundary cases for 0xFF01 (ResetCalibrationToDefaults).
