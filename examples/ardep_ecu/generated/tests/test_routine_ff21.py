...
#
# Run:  pytest generated/tests/test_routine_ff21.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 65313
ROUTINE_HEX:      str  = "0xFF21"
ROUTINE_NAME:     str  = "MeasureSupplyVoltage"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 33
...
class TestStartMeasuresupplyvoltage:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF21 (MeasureSupplyVoltage)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xFF21 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xFF, 0x21]
...
class TestResultsMeasuresupplyvoltage:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF21

    MeasureSupplyVoltage has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xFF21 after start.
...
class TestStopNotSupportedMeasuresupplyvoltage:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF21

    MeasureSupplyVoltage does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateMeasuresupplyvoltage:
    """
    0xFF21 (MeasureSupplyVoltage) requires extended session (ordinal 3).
...
class TestProtocolMeasuresupplyvoltage:
    """
    Protocol boundary cases for 0xFF21 (MeasureSupplyVoltage).
