...
#
# Run:  pytest generated/tests/test_routine_ff20.py -v
# =============================================================================
...
# ── Routine under test ────────────────────────────────────────────────────────
ROUTINE_ID:       int  = 65312
ROUTINE_HEX:      str  = "0xFF20"
ROUTINE_NAME:     str  = "ActivateOutputChannel"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 32
...
class TestStartActivateoutputchannel:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF20 (ActivateOutputChannel)
    ...
    def test_happy_path_start(
        ...
        """
        startRoutine 0xFF20 with all preconditions satisfied.
        Expected: [0x71, 0x01, 0xFF, 0x20]
...
class TestResultsActivateoutputchannel:
    """
    SID 0x31 sub-function 0x03 — requestRoutineResults 0xFF20

    ActivateOutputChannel has ROUTINE_SUPPORT_RESULTS.
    """
    ...
    def test_request_results(
        ...
        """
        requestRoutineResults 0xFF20 after start.
...
class TestSessionGateActivateoutputchannel:
    """
    0xFF20 (ActivateOutputChannel) requires extended session (ordinal 3).
...
class TestSecurityGateActivateoutputchannel:
    """
    0xFF20 (ActivateOutputChannel) requires security_level 1.
    ...
    def test_rejected_without_security_unlock(self, uds_bus: IsoTpTransport) -> None:
        """
        startRoutine 0xFF20 without Level 1 unlock → NRC 0x33.
        """
        if MIN_SESSION_BYTE != SESSION_DEFAULT:
...
class TestProtocolActivateoutputchannel:
    """
    Protocol boundary cases for 0xFF20 (ActivateOutputChannel).
