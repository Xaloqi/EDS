...
ROUTINE_NAME:     str  = "ResetToFactoryDefaults"
ROUTINE_HI:       int  = 255
ROUTINE_LO:       int  = 1
...
class TestStartResettofactorydefaults:
    """
    SID 0x31 sub-function 0x01 — startRoutine 0xFF01 (ResetToFactoryDefaults)
...
class TestStopNotSupportedResettofactorydefaults:
    """
    SID 0x31 sub-function 0x02 — stopRoutine 0xFF01

    ResetToFactoryDefaults does NOT have ROUTINE_SUPPORT_STOP.
...
class TestSessionGateResettofactorydefaults:
    """
    0xFF01 (ResetToFactoryDefaults) requires extended session (ordinal 3).
...
class TestSecurityGateResettofactorydefaults:
    """
    0xFF01 (ResetToFactoryDefaults) requires security_level 1.
...
class TestProtocolResettofactorydefaults:
    """
    Protocol boundary cases for 0xFF01 (ResetToFactoryDefaults).
